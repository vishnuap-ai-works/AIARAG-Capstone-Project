...
This document outlines the end-to-end architecture of the Document Ingestion Pipeline. It details the high-level user workflow and the underlying Python orchestration that processes raw files into AI-ready vectors.
